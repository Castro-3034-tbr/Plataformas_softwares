...
rospy.init_node("accion_cliente")#Inciamos el nodo de accion_cliente


cliente = actionlib.SimpleActionClient("accion_servidor",MensajeAction)#Creamos el cliente de accion
cliente.wait_for_server()#Esperamos a que el servidor este listo
