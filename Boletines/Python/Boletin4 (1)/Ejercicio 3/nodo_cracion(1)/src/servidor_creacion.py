...
from nodo_cracion.srv import DatosCreacion, DatosCreacionResponse
...
def creacion_personajes(req):
    ...
    #Creacion del punto objetivo 
    datos_punto_objetivo = SpawnRequest()
    datos_punto_objetivo.x = 5
    datos_punto_objetivo.y = 5
    objetivo = s_spawn(datos_punto_objetivo)
    rospy.loginfo("Objetivo created")
